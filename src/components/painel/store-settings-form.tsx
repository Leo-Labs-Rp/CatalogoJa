      ...
      <Card className="p-5 sm:p-6">
        <form className="grid gap-5" onSubmit={submit}>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <StoreImageField description="Escolha uma imagem larga para o topo da loja, como uma foto de capa." id="banner" kind="banner" label="Banner da loja" onChange={(file) => selectImage("banner", file)} state={bannerImage} />
